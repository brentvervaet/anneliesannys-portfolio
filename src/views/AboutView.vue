		...
		<section class="about-content">
			<div class="about-text">
				...
				<p>
					...
					Ghent. My work focuses on blurring the boundaries between memory, emotion, and
					materiality. Through collage, text, and clothing, I translate personal
					experiences into tangible forms.
				</p>
				<p>
					My process often begins with an inner narrative, a dream, a diary fragment, or a
					fleeting feeling, which gradually develops through experimentation with layers,
					textures, and form. By using collage as the first step in my design process, I
					explore composition, proportion, and the relationship between body and form.
					This method allows me to experiment freely, creating intuitive connections
					between image, texture, and silhouette before translating them into garments.
				</p>
				<p>
					Fashion is a language of reflection and connection: a way to communicate between
					what is hidden and what is revealed, between my own world and that of others.
					Each project is an attempt to hold onto what might otherwise be lost, while
					allowing it to transform into something new.
				</p>
			</div>
				...
				<div class="timeline">
					<div class="timeline-item">
						...
						<div class="timeline-events">
							<div class="timeline-event">Coming soon ...</div>
						</div>
					</div>
					...
					<div class="timeline-item">
						...
						<div class="timeline-events">
							<div class="timeline-event">
								Making, Healing, Connecting (Soft Connection Lab), Museum Dr.
								Guislain, Belgium
							</div>
						</div>
					</div>
